...
int main()
{
	Tree MyTree, Node1, Node2, Node3, Node4, Node5;
	int del;
	MyTree = CreateNode(1);
	CreateTree(MyTree);
	Node1 = CreateNode(2);
	...
	Node4 = CreateNode(5);
	Node5 = CreateNode(6);
	AddNode(MyTree, Node1);
	AddNode(MyTree, Node2);
	AddNode(Node1, Node3);
	AddNode(Node2, Node4);
	AddNode(Node1, Node5);
	cout << endl << "The tree: " << endl;
	PrintTree(MyTree);
	cout << endl << "Enter the deleting node: " << endl;
	cin >> del;
	cout << "The tree after delete: " <<endl;
	DeleteNode(MyTree, del);
	PrintTree(MyTree);
	return 0;
}
